	...
	render() {
		...
		return (<>
			<section className="historia">
				...
				<p>
					El 1997 es va fer el primer viatge a Perpinyà, on finalment vam descarregar el primer 3 de 6 de la colla. Era un bon presagi, perquè l'objectiu de la temporada era el 5 de 6, que vam descarregar a la Diada el maig d'aquell mateix any, junt amb el primer pilar de 5 carregat.
				</p>
				<p>
